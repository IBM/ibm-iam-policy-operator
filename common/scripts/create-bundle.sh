...
cp -p deploy/olm-catalog/ibm-iam-policy-operator/ibm-iam-policy-operator.package.yaml bundle/
cp -p deploy/olm-catalog/ibm-iam-policy-operator/3.6.1/*.yaml bundle/

cd bundle || exit
zip ibm-iam-policy-metadata ./*.yaml
cd ..
