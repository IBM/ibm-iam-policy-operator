...
import (
	...
	"github.com/IBM/ibm-iam-policy-operator/controllers"
...
func main() {
	...
	if err = (&controllers.PolicyControllerReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("PolicyController"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "PolicyController")
		os.Exit(1)
	}
